...
trait DatabaseMigrations
{
    ...
    {
        // No RefreshDatabaseState::$migrated gate here, unlike the package's
        // DatabaseTruncation and RefreshDatabase: the framework trait runs
        // `migrate:fresh` before every test (its teardown `migrate:rollback`
        // resets the flag), so the pre-wipe must run every time too.
