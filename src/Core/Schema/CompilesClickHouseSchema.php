...
trait CompilesClickHouseSchema
{
    ...
    /**
     * Normalize the arguments the frameworks pass to compileColumns() and
     * compileIndexes(). Laravel 11 passes the table alone; Laravel 12+ and
     * Hypervel pass the schema first, leaving the table in the second
     * argument.
     *
