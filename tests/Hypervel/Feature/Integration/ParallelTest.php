...
/**
 * Runs inside a Swoole coroutine via RunTestsInCoroutine, so this suite
 * also pins that the Guzzle multi-curl parallel path works under the
 * native curl hook, which reschedules the blocking multi handle.
 */
...
class ParallelTestModel extends Model
{
    ...
    protected ?string $table = 'parallel_test';
